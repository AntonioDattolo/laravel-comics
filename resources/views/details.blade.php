...
$comic_selected = $_GET["selected_details"]
?>
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <section class="container d-flex flex-wrap">
                ...
                <h3 class="col-12 text-center p-1">SERIES :  {{$film[$comic_selected]['series']}}</h3>
                <h5 class="col-12 text-center p-1">
                    {{$film[$comic_selected]['type']}}
                </h5>
                <div class="col-5 p-1">
                    <img src="{{$film[$comic_selected]['thumb']}}" alt="">
                </div>
                <div class="col-7 align-self-center p-5 " style="font-size: 32px;">
                    <p>
                        {{$film[$comic_selected]['description']}}
                    </p>
                </div>
                <div class="col-12 d-flex p-1">
                    <h4 class="col-8">
                        Sale Date :
                        {{$film[$comic_selected]['sale_date']}}
                    </h4>
                    <h5 class="col-4 text-end p-1" style="font-size: 35px;">
                        {{$film[$comic_selected]['price']}}
                    </h5>
                </div>
        </section>
    </body>
